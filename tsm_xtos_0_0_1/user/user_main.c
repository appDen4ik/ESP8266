...
//*********************************************************************************************************************
	...
	ets_uart_printf(" ѕроверка insert  и  find ");

	os_delay_us(500000);

	ets_uart_printf(" ѕ.1 «аполн€ем начальный сектор значени€ми (ASCII) выровн€ными по 256 символов  ");
...
c:
	...
	ets_uart_printf(" “естирование успешно завершено ");
